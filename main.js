...
window.addEventListener("load", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (!taskInput) {
      ...
      // [2] Create | <div class="content"> TaskInput content in
      ...
      // [6] Create |
      const taskContentEl1 = document.createElement("div");
      taskContentEl1.classList.add("actions");
      ...
      taskDeleteEl.classList.add("delete"); //action
